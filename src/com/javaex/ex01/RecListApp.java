...
public class RecListApp {
	...
	public static void main(String[] args) {
		...
		for(int i =0; i<rList.size(); i++) {
			sum = rList.get(i).getWidth()*rList.get(i).getHeight()+sum;
		}
	...
	public static void listAllDraw(List<Rectangle> list) {
		...
		for(int i=0; i<list.size(); i++) {
			double result = list.get(i).getWidth()*list.get(i).getHeight();
			System.out.println("[사각형]가로:"+list.get(i).getWidth()+" 세로:"+list.get(i).getHeight()+" 을 그렸습니다.");
		}
